...
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZHD(const char *name ,void* param1,int param2,int32_t param3,int32_t param4,int32_t param5,int32_t param6,int32_t param7,int32_t param8 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZHE(const char *name ,void* param1,int32_t param2,int32_t param3,int32_t param4 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZHF(const char *name ,void* param1,int param2,int32_t param3 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZHG(const char *name ,int8_t param1 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZHH(const char *name ,uint8_t param1 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZHI(const char *name ,int16_t param1 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZHJ(const char *name ,uint16_t param1 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZHK(const char *name ,int32_t param1 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZHL(const char *name ,uint32_t param1 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZHM(const char *name ,int64_t param1 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZHN(const char *name ,uint64_t param1 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZHO(const char *name ,float param1 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZHP(const char *name ,double param1 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZHQ(const char *name ,void* param1 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZHR(const char *name ,void* param1,int32_t param2 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZHS(const char *name ,void* param1,int32_t param2,int32_t param3 );
ASPOSE_CELLS_API c_return_int8_value* CellsGoFunctoinZZHT(const char *name ,void* param1 );
ASPOSE_CELLS_API c_return_int16_value* CellsGoFunctoinZZHU(const char *name ,void* param1 );
ASPOSE_CELLS_API c_return_uint16_value* CellsGoFunctoinZZHV(const char *name ,void* param1 );
ASPOSE_CELLS_API c_return_uint_value* CellsGoFunctoinZZHW(const char *name ,void* param1 );
ASPOSE_CELLS_API c_return_ulong_value* CellsGoFunctoinZZHX(const char *name ,void* param1 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZHY(const char *name ,void* param1,double param2,double param3 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZIA(const char *name ,void* param1,int32_t param2,void* param3,int32_t param4 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZIB(const char *name ,void* param1,bool param2,bool param3,bool param4,int32_t param5,void* param6,int32_t param7 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZIC(const char *name ,void* param1,bool param2,int32_t param3 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZID(const char *name ,void* param1,bool param2,bool param3,bool param4,int32_t param5 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZIE(const char *name ,void* param1,char* param2,int32_t param3,int32_t param4,int32_t param5,int32_t param6 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZIF(const char *name ,void* param1,char* param2,char* param3,char* param4 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZIG(const char *name ,void* param1,void* param2,int32_t param3 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZIH(const char *name ,void* param1,int param2,void* param3 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZII(const char *name ,void* param1,void* param2,int32_t param3,void* param4,int32_t param5 );
...
ASPOSE_CELLS_API c_return_string_value* CellsGoFunctoinZZIL(const char *name ,void* param1,void* param2 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZIM(const char *name ,void* param1,bool param2,bool param3 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZIN(const char *name ,void* param1,int32_t param2,int32_t param3,char* param4 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZIO(const char *name ,void* param1,int param2,char* param3 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZIP(const char *name ,void* param1,bool param2,char* param3 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZIQ(const char *name ,void* param1,char* param2,char* param3,bool param4 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZIR(const char *name ,void* param1,int param2,void* param3,void* param4 );
...
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZIU(const char *name ,void* param1,void* param2,void* param3,int param4,int32_t param5 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZIV(const char *name ,int param1,double param2 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZIW(const char *name ,void* param1,char* param2,char* param3,char* param4 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZIX(const char *name ,void* param1,char* param2,void* param3 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZIY(const char *name ,void* param1,void* param2,int param3,int32_t param4 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZJA(const char *name ,void* param1,void* param2,bool param3,bool param4 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZJB(const char *name ,void* param1,void* param2,int32_t param3,bool param4,bool param5 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZJC(const char *name ,char* param1,void* param2 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZJD(const char *name ,void* param1,int32_t param2,void* param3 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZJE(const char *name ,void* param1,char* param2,int param3 );
...
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZLG(const char *name ,void* param1,void* param2,int32_t param3 );
...
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZLP(const char *name ,void* param1,int32_t param2,int32_t param3,int32_t param4,int32_t param5,int32_t param6,int32_t param7 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZLQ(const char *name ,void* param1,int32_t param2,int32_t param3,int32_t param4,int32_t param5,int32_t param6,int32_t param7,char* param8 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZLR(const char *name ,void* param1,int param2,char* param3,char* param4,int32_t param5,bool param6,bool param7,int32_t param8,int32_t param9,int32_t param10,int32_t param11 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZLS(const char *name ,void* param1,int param2,char* param3,char* param4,int32_t param5,bool param6,bool param7,int32_t param8,int32_t param9,int32_t param10,int32_t param11,int32_t param12,int32_t param13 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZLT(const char *name ,void* param1,int param2,char* param3,int32_t param4,int32_t param5,int32_t param6,int32_t param7,int32_t param8,int32_t param9 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZLU(const char *name ,void* param1,int param2,int32_t param3,int32_t param4,int32_t param5,int32_t param6,void* param7,int32_t param8,bool param9 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZLV(const char *name ,void* param1,int param2,int param3,int32_t param4,int32_t param5,int32_t param6,int32_t param7,void* param8,int32_t param9 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZLW(const char *name ,void* param1,int param2,int param3,int32_t param4,int32_t param5,int32_t param6,int32_t param7 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZLX(const char *name ,void* param1,int param2,int param3,double param4,double param5,double param6,double param7 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZLY(const char *name ,void* param1,int param2,int param3,double param4,double param5,double param6,double param7,void* param8,int32_t param9 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZMA(const char *name ,void* param1,int param2,int32_t param3,int32_t param4,int32_t param5,int32_t param6,int32_t param7,int32_t param8 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZMB(const char *name ,void* param1,int param2,int32_t param3,int32_t param4,int32_t param5,int32_t param6 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZMC(const char *name ,void* param1,int32_t param2,int32_t param3,int32_t param4,int32_t param5,void* param6,int32_t param7 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZMD(const char *name ,void* param1,int32_t param2,int32_t param3,void* param4,int32_t param5,int32_t param6,int32_t param7 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZME(const char *name ,void* param1,int32_t param2,int32_t param3,int32_t param4,int32_t param5,int32_t param6,int32_t param7,void* param8,int32_t param9,void* param10,int32_t param11 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZMF(const char *name ,void* param1,int32_t param2,int32_t param3,int32_t param4,int32_t param5,char* param6 );
...
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZMH(const char *name ,void* param1,void* param2,void* param3,int32_t param4,int32_t param5 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZMI(const char *name ,void* param1,void* param2,void* param3,int32_t param4,int32_t param5,bool param6 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZMJ(const char *name ,void* param1,int32_t param2,int32_t param3,int32_t param4,int32_t param5,int32_t param6,int32_t param7,void* param8,int32_t param9 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZMK(const char *name ,void* param1,int32_t param2,int32_t param3,void* param4 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZML(const char *name ,void* param1,float param2,float param3 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZMM(const char *name ,void* param1,float param2,float param3,float param4,float param5,float param6,float param7 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZMN(const char *name ,void* param1,float param2,float param3,float param4,float param5 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZMO(const char *name ,void* param1,int32_t param2,int32_t param3,char* param4 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZMP(const char *name ,void* param1,int param2,double param3 );
ASPOSE_CELLS_API c_return_bool_value* CellsGoFunctoinZZMQ(const char *name ,void* param1,int32_t param2,int32_t param3,int32_t param4 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZMR(const char *name ,void* param1,int16_t param2 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZMS(const char *name ,void* param1,int64_t param2 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZMT(const char *name ,void* param1,char* param2,float param3,float param4,int param5,int param6 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZMU(const char *name ,void* param1,float param2,float param3,int param4,int param5 );
ASPOSE_CELLS_API c_return_bool_value* CellsGoFunctoinZZMV(const char *name ,void* param1,int param2,bool param3 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZMW(const char *name ,void* param1,int param2,int32_t param3,int32_t param4,int32_t param5,int32_t param6 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZMX(const char *name ,void* param1,void* param2,int32_t param3,char* param4,bool param5,int32_t param6,int32_t param7,int32_t param8,int32_t param9 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZMY(const char *name ,void* param1,int param2,char* param3,bool param4,int32_t param5,int32_t param6,int32_t param7,int32_t param8 );
ASPOSE_CELLS_API c_return_float_value* CellsGoFunctoinZZNA(const char *name ,void* param1,int32_t param2 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZNB(const char *name ,void* param1,int32_t param2,char* param3,bool param4 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZNC(const char *name ,void* param1,char* param2,bool param3 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZND(const char *name ,void* param1,char* param2,bool param3,bool param4 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZNE(const char *name ,void* param1,char* param2,bool param3,void* param4 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZNF(const char *name ,void* param1,int param2,char* param3,bool param4,void* param5 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZNG(const char *name ,void* param1,char* param2,void* param3 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZNH(const char *name ,void* param1,char* param2,bool param3 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZNI(const char *name ,void* param1,char* param2,double param3 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZNJ(const char *name ,char* param1,void* param2,char* param3,void* param4 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZNK(const char *name ,char* param1,void* param2,int32_t param3,int32_t param4,void* param5 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZNL(const char *name ,char* param1,void* param2,int32_t param3 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZNM(const char *name ,void* param1,int param2,int32_t param3,int param4 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZNN(const char *name ,void* param1,int32_t param2,int32_t param3,int param4 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZNO(const char *name ,void* param1,double param2,bool param3 );
...
ASPOSE_CELLS_API c_return_bool_value* CellsGoFunctoinZZNQ(const char *name ,void* param1,double param2,double param3,double param4,bool param5 );
ASPOSE_CELLS_API c_return_bool_value* CellsGoFunctoinZZNR(const char *name ,void* param1,void* param2,int32_t param3,bool param4 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZNS(const char *name ,void* param1,int32_t param2,int param3,bool param4,int32_t param5 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZNT(const char *name ,void* param1,int32_t param2,int param3,double param4,double param5 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZNU(const char *name ,void* param1,int param2,char* param3,char* param4 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZNV(const char *name ,void* param1,int param2,void* param3,void* param4 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZNW(const char *name ,void* param1,int param2,int32_t param3,int param4,char* param5 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZNX(const char *name ,void* param1,int param2,int32_t param3,int param4,int32_t param5 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZNY(const char *name ,void* param1,int32_t param2,int32_t param3,int param4,bool param5,int32_t param6 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZOA(const char *name ,void* param1,int32_t param2,int32_t param3,int param4,double param5,double param6 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZOB(const char *name ,void* param1,int32_t param2,int param3,char* param4,char* param5 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZOC(const char *name ,void* param1,int32_t param2,int param3,void* param4,void* param5 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZOD(const char *name ,void* param1,int32_t param2,void* param3,int32_t param4 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZOE(const char *name ,void* param1,int param2,void* param3 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZOF(const char *name ,void* param1,void* param2 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZOG(const char *name ,void* param1,int32_t param2,int32_t param3,bool param4,int32_t param5,int32_t param6 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZOH(const char *name ,void* param1,char* param2,char* param3,char* param4,bool param5 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZOI(const char *name ,void* param1,char* param2,int32_t param3,int32_t param4,char* param5,bool param6 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZOJ(const char *name ,void* param1,char* param2,int32_t param3,int32_t param4,char* param5,bool param6,bool param7 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZOK(const char *name ,void* param1,char* param2,char* param3,char* param4,bool param5,bool param6 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZOL(const char *name ,void* param1,void* param2,char* param3,char* param4 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZOM(const char *name ,void* param1,void* param2,int32_t param3,int32_t param4,char* param5 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZON(const char *name ,void* param1,void* param2,int32_t param3,bool param4,void* param5,char* param6,char* param7 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZOO(const char *name ,void* param1,void* param2,int32_t param3,bool param4,void* param5,int32_t param6,int32_t param7,char* param8 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZOP(const char *name ,void* param1,int param2,int32_t param3,int param4,int param5,bool param6,bool param7,void* param8 );
ASPOSE_CELLS_API c_return_float_value* CellsGoFunctoinZZOQ(const char *name ,void* param1,int param2 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZOR(const char *name ,void* param1,void* param2,float param3,float param4,float param5,float param6 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZOS(const char *name ,char* param1,float param2 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZOT(const char *name ,void* param1,int32_t param2 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZOU(const char *name ,void* param1,int32_t param2 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZOV(const char *name ,void* param1,void* param2,int32_t param3,void* param4,int32_t param5 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZOW(const char *name ,void* param1,int32_t param2,char* param3,char* param4,void* param5 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZOX(const char *name ,char* param1,char* param2,char* param3,void* param4 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZOY(const char *name ,bool param1,bool param2 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZPA(const char *name ,void* param1,int32_t param2,int32_t param3,void* param4,bool param5 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZPB(const char *name ,void* param1,int32_t param2,int32_t param3,char* param4,bool param5 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZPC(const char *name ,void* param1,int32_t param2,int32_t param3,int32_t param4,int32_t param5,bool param6 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZPD(const char *name ,void* param1,int32_t param2,int32_t param3,int param4,char* param5 );
ASPOSE_CELLS_API c_return_string_value* CellsGoFunctoinZZPE(const char *name ,void* param1,int param2,char* param3 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZPF(const char *name ,void* param1,char* param2,bool param3,int param4,char* param5,int param6 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZPG(const char *name ,void* param1,void* param2,int32_t param3,int32_t param4,int32_t param5 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZPH(const char *name ,void* param1,void* param2,char* param3,int32_t param4 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZPI(const char *name ,void* param1,void* param2,int32_t param3,int32_t param4,void* param5 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZPJ(const char *name ,void* param1,void* param2,char* param3,void* param4 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZPK(const char *name ,void* param1,void* param2,int32_t param3,char* param4 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZPL(const char *name ,void* param1,void* param2,void* param3,char* param4 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZPM(const char *name ,void* param1,void* param2,void* param3,int32_t param4,int32_t param5 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZPN(const char *name ,void* param1,char* param2,void* param3,int32_t param4 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZPO(const char *name ,void* param1,void* param2,char* param3 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZPP(const char *name ,void* param1,char* param2,char* param3,void* param4,int32_t param5 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZPQ(const char *name ,void* param1,char* param2,char* param3,char* param4,char* param5 );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZPR(const char *name ,void* param1,char* param2,bool param3,int32_t param4,int32_t param5 );
ASPOSE_CELLS_API c_return_ptr_value* CellsGoFunctoinZZPS(const char *name  );
ASPOSE_CELLS_API c_return_int_value* CellsGoFunctoinZZPT(const char *name ,void* param1 );
ASPOSE_CELLS_API c_return_void_value* CellsGoFunctoinZZPU(const char *name ,void* param1,uint8_t param2 );
