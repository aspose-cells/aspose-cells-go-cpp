...
func Int32ToSlicerCacheCrossFilterType(value int32) (SlicerCacheCrossFilterType, error) {
	switch value {
	case 0:
		return SlicerCacheCrossFilterType_None, nil
	case 1:
		return SlicerCacheCrossFilterType_ShowItemsWithDataAtTop, nil
	case 2:
		return SlicerCacheCrossFilterType_ShowItemsWithNoData, nil
	default:
...
func Int32ToSlicerCacheItemSortType(value int32) (SlicerCacheItemSortType, error) {
	switch value {
	case 0:
		return SlicerCacheItemSortType_Natural, nil
	case 1:
		return SlicerCacheItemSortType_Ascending, nil
	case 2:
		return SlicerCacheItemSortType_Descending, nil
	default:
...
func Int32ToSlicerStyleType(value int32) (SlicerStyleType, error) {
	switch value {
	case 0:
		return SlicerStyleType_SlicerStyleLight1, nil
	case 1:
		return SlicerStyleType_SlicerStyleLight2, nil
	case 2:
		return SlicerStyleType_SlicerStyleLight3, nil
	case 3:
		return SlicerStyleType_SlicerStyleLight4, nil
	case 4:
		return SlicerStyleType_SlicerStyleLight5, nil
	case 5:
		return SlicerStyleType_SlicerStyleLight6, nil
	case 6:
		return SlicerStyleType_SlicerStyleOther1, nil
	case 7:
		return SlicerStyleType_SlicerStyleOther2, nil
	case 8:
		return SlicerStyleType_SlicerStyleDark1, nil
	case 9:
		return SlicerStyleType_SlicerStyleDark2, nil
	case 10:
		return SlicerStyleType_SlicerStyleDark3, nil
	case 11:
		return SlicerStyleType_SlicerStyleDark4, nil
	case 12:
		return SlicerStyleType_SlicerStyleDark5, nil
	case 13:
		return SlicerStyleType_SlicerStyleDark6, nil
	case 14:
		return SlicerStyleType_Custom, nil
	default:
