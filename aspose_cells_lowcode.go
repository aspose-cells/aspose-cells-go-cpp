...
func (instance *AbstractLowCodeProtectionProvider) GetWorksheetPassword(sheetname string)  (string,  error)  {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZGR(C.CString("AbstractLowCodeProtectionProvider_GetWorksheetPassword"), instance.ptr, C.CString(sheetname))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  "", err
	}
...
func (instance *AbstractLowCodeProtectionProvider) GetWorksheetProtectionType(sheetname string)  (ProtectionType,  error)  {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZKO(C.CString("AbstractLowCodeProtectionProvider_GetWorksheetProtectionType"), instance.ptr, C.CString(sheetname))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  0, err
	}
...
func HtmlConverter_Process_String_String(templatefile string, resultfile string)  error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZKP(C.CString("HtmlConverter_Process_String_String"),C.CString(templatefile), C.CString(resultfile))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func ImageConverter_Process_String_String(templatefile string, resultfile string)  error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZKP(C.CString("ImageConverter_Process_String_String"),C.CString(templatefile), C.CString(resultfile))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func JsonConverter_Process_String_String(templatefile string, resultfile string)  error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZKP(C.CString("JsonConverter_Process_String_String"),C.CString(templatefile), C.CString(resultfile))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func NewLowCodeSaveOptionsProviderOfPlaceHolders_String(pathtemplate string) ( *LowCodeSaveOptionsProviderOfPlaceHolders, error) {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZFR(C.CString("New_LowCodeSaveOptionsProviderOfPlaceHolders_String"),C.CString(pathtemplate))
	if CGoReturnPtr.error_no == 0 {
...
func PdfConverter_Process_String_String(templatefile string, resultfile string)  error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZKP(C.CString("PdfConverter_Process_String_String"),C.CString(templatefile), C.CString(resultfile))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func SpreadsheetConverter_Process_String_String(templatefile string, resultfile string)  error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZKP(C.CString("SpreadsheetConverter_Process_String_String"),C.CString(templatefile), C.CString(resultfile))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func SpreadsheetLocker_Process_String_String_String_String(templatefile string, resultfile string, openpassword string, writepassword string)  error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZKQ(C.CString("SpreadsheetLocker_Process_String_String_String_String"),C.CString(templatefile), C.CString(resultfile), C.CString(openpassword), C.CString(writepassword))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func SpreadsheetLocker_Process_LowCodeLoadOptions_LowCodeSaveOptions_String_String(loadoptions *LowCodeLoadOptions, saveoptions *LowCodeSaveOptions, openpassword string, writepassword string)  error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZKR(C.CString("SpreadsheetLocker_Process_LowCodeLoadOptions_LowCodeSaveOptions_String_String"),loadoptions_ptr, saveoptions_ptr, C.CString(openpassword), C.CString(writepassword))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func SpreadsheetLocker_Process_LowCodeLoadOptions_LowCodeSaveOptions_String_String_String_ProtectionType(loadoptions *LowCodeLoadOptions, saveoptions *LowCodeSaveOptions, openpassword string, writepassword string, workbookpassword string, workbooktype ProtectionType)  error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZKS(C.CString("SpreadsheetLocker_Process_LowCodeLoadOptions_LowCodeSaveOptions_String_String_String_ProtectionType"),loadoptions_ptr, saveoptions_ptr, C.CString(openpassword), C.CString(writepassword), C.CString(workbookpassword), C.int( int32(workbooktype)))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func SpreadsheetMerger_Process_stringArray_String(templatefiles []string, resultfile string)  error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZKT(C.CString("SpreadsheetMerger_Process_U16StringArray_String"),unsafe.Pointer(&vector_templatefiles[0]), C.int( len(templatefiles)), C.CString(resultfile))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func SpreadsheetSplitter_Process_String_String(templatefile string, resultfile string)  error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZKP(C.CString("SpreadsheetSplitter_Process_String_String"),C.CString(templatefile), C.CString(resultfile))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func TextConverter_Process_String_String(templatefile string, resultfile string)  error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZKP(C.CString("TextConverter_Process_String_String"),C.CString(templatefile), C.CString(resultfile))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
