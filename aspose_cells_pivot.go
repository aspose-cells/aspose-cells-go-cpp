...
func (instance *PivotConditionalFormat) ApplyTo(row int32, column int32, scope PivotConditionFormatScopeType)  error {
	...
	CGoReturnPtr := C.PivotConditionalFormat_ApplyTo( instance.ptr, C.int(row), C.int(column), C.int( int32(scope)))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func (instance *PivotField) GroupBy_Date_Date_PivotGroupByTypeArray_Double_Bool(start time.Time, end time.Time, groups []PivotGroupByType, interval float64, firstasnewfield bool)  (bool,  error)  {
	...
	CGoReturnPtr := C.PivotField_GroupBy_Date_Date_PivotGroupByTypeArray_Double_Boolean( instance.ptr, time_start, time_end, unsafe.Pointer(&groups[0]), C.int( len(groups)), C.double(interval), C.bool(firstasnewfield))
...
func (instance *PivotField) GroupBy_CustomPiovtFieldGroupItemArray_Bool(customgroupitems []CustomPiovtFieldGroupItem, newfield bool)  (bool,  error)  {
	...
	CGoReturnPtr := C.PivotField_GroupBy_CustomPiovtFieldGroupItemArray_Boolean( instance.ptr, unsafe.Pointer(&vector_customgroupitems[0]), C.int( len(customgroupitems)), C.bool(newfield))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  true, err
	}
...
func (instance *PivotField) FilterByDate(type_ PivotFilterType, datetime1 time.Time, datetime2 time.Time)  (*PivotFilter,  error)  {
	...
	CGoReturnPtr := C.PivotField_FilterByDate( instance.ptr, C.int( int32(type_)), time_datetime1, time_datetime2)
...
func (instance *PivotField) SetCurrentPageItem(value int16)  error {
	...
	CGoReturnPtr := C.PivotField_SetCurrentPageItem( instance.ptr, C.short(value))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func (instance *PivotFieldCollection) GetEnumerator()  (*PivotFieldEnumerator,  error)  {
	...
	CGoReturnPtr := C.PivotFieldCollection_GetEnumerator( instance.ptr)
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  nil, err
	}
...
func (instance *PivotFilter) GetDateTimeValues()  ([]time.Time,  error)  {
	...
	for i := 0; i < int(CGoReturnPtr.column_length); i++ {
	   ...
	   result[i] = time.Date(int( C.Date_Get_year(goObjectPtr).return_value ),time.Month(int( C.Date_Get_month(goObjectPtr).return_value)),int( C.Date_Get_day(goObjectPtr).return_value),int(  C.Date_Get_hour(goObjectPtr).return_value),int( C.Date_Get_minute(goObjectPtr).return_value),int(  C.Date_Get_second(goObjectPtr).return_value), 0, time.UTC)
	}
...
func (instance *PivotFilterCollection) AddDateFilter(basefieldindex int32, type_ PivotFilterType, datetime1 time.Time, datetime2 time.Time)  (*PivotFilter,  error)  {
	...
	CGoReturnPtr := C.PivotFilterCollection_AddDateFilter( instance.ptr, C.int(basefieldindex), C.int( int32(type_)), time_datetime1, time_datetime2)
	C.Delete_GetDate( time_datetime1)
	C.Delete_GetDate( time_datetime2)
...
func (instance *PivotItemCollection) GetEnumerator()  (*PivotItemEnumerator,  error)  {
	...
	CGoReturnPtr := C.PivotItemCollection_GetEnumerator( instance.ptr)
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  nil, err
	}
...
func (instance *PivotTable) GetSource_Bool(isoriginal bool)  ([]string,  error)  {
	...
	CGoReturnPtr := C.PivotTable_GetSource_Boolean( instance.ptr, C.bool(isoriginal))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  nil, err
	}
