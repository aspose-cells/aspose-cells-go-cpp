...
func Int32ToOdsCellFieldType(value int32) (OdsCellFieldType, error) {
	switch value {
	case 0:
		return OdsCellFieldType_Date, nil
	case 1:
		return OdsCellFieldType_SheetName, nil
	case 2:
		return OdsCellFieldType_Title, nil
	default:
...
func Int32ToOdsGeneratorType(value int32) (OdsGeneratorType, error) {
	switch value {
	case 0:
		return OdsGeneratorType_LibreOffice, nil
	case 1:
		return OdsGeneratorType_OpenOffice, nil
	default:
...
func Int32ToOdsPageBackgroundGraphicPositionType(value int32) (OdsPageBackgroundGraphicPositionType, error) {
	switch value {
	case 0:
		return OdsPageBackgroundGraphicPositionType_TopLeft, nil
	case 1:
		return OdsPageBackgroundGraphicPositionType_TopCenter, nil
	case 2:
		return OdsPageBackgroundGraphicPositionType_TopRight, nil
	case 3:
		return OdsPageBackgroundGraphicPositionType_CenterLeft, nil
	case 4:
		return OdsPageBackgroundGraphicPositionType_CenterCenter, nil
	case 5:
		return OdsPageBackgroundGraphicPositionType_CenterRight, nil
	case 6:
		return OdsPageBackgroundGraphicPositionType_BottomLeft, nil
	case 7:
		return OdsPageBackgroundGraphicPositionType_BottomCenter, nil
	case 8:
		return OdsPageBackgroundGraphicPositionType_BottomRight, nil
	default:
...
func Int32ToOdsPageBackgroundGraphicType(value int32) (OdsPageBackgroundGraphicType, error) {
	switch value {
	case 0:
		return OdsPageBackgroundGraphicType_Position, nil
	case 1:
		return OdsPageBackgroundGraphicType_Area, nil
	case 2:
		return OdsPageBackgroundGraphicType_Tile, nil
	default:
...
func Int32ToOdsPageBackgroundType(value int32) (OdsPageBackgroundType, error) {
	switch value {
	case 0:
		return OdsPageBackgroundType_None, nil
	case 1:
		return OdsPageBackgroundType_Color, nil
	case 2:
		return OdsPageBackgroundType_Graphic, nil
	default:
...
func Int32ToOpenDocumentFormatVersionType(value int32) (OpenDocumentFormatVersionType, error) {
	switch value {
	case 0:
		return OpenDocumentFormatVersionType_None, nil
	case 1:
		return OpenDocumentFormatVersionType_Odf11, nil
	case 2:
		return OpenDocumentFormatVersionType_Odf12, nil
	case 3:
		return OpenDocumentFormatVersionType_Odf13, nil
	default:
