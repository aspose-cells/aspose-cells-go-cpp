...
func Int32ToRevisionActionType(value int32) (RevisionActionType, error) {
	switch value {
	case 0:
		return RevisionActionType_Add, nil
	case 1:
		return RevisionActionType_Delete, nil
	case 2:
		return RevisionActionType_DeleteColumn, nil
	case 3:
		return RevisionActionType_DeleteRow, nil
	case 4:
		return RevisionActionType_InsertColumn, nil
	case 5:
		return RevisionActionType_InsertRow, nil
	default:
...
func Int32ToRevisionType(value int32) (RevisionType, error) {
	switch value {
	case 0:
		return RevisionType_CustomView, nil
	case 1:
		return RevisionType_DefinedName, nil
	case 2:
		return RevisionType_ChangeCells, nil
	case 3:
		return RevisionType_AutoFormat, nil
	case 4:
		return RevisionType_MergeConflict, nil
	case 5:
		return RevisionType_Comment, nil
	case 6:
		return RevisionType_Format, nil
	case 7:
		return RevisionType_InsertSheet, nil
	case 8:
		return RevisionType_MoveCells, nil
	case 9:
		return RevisionType_Undo, nil
	case 10:
		return RevisionType_QueryTable, nil
	case 11:
		return RevisionType_InsertDelete, nil
	case 12:
		return RevisionType_RenameSheet, nil
	case 13:
		return RevisionType_Unknown, nil
	default:
