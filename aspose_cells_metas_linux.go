...
func (instance *SensitivityLabel) GetId()  (string,  error)  {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZZM(C.CString("SensitivityLabel_GetId"), instance.ptr)
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  "", err
	}
...
func (instance *SensitivityLabel) SetId(value string)  error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZZN(C.CString("SensitivityLabel_SetId"), instance.ptr, C.CString(value))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func (instance *SensitivityLabel) GetAssignmentType()  (SensitivityLabelAssignmentType,  error)  {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZZK(C.CString("SensitivityLabel_GetAssignmentType"), instance.ptr)
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  0, err
	}
...
func (instance *SensitivityLabel) SetAssignmentType(value SensitivityLabelAssignmentType)  error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZZL(C.CString("SensitivityLabel_SetAssignmentType"), instance.ptr, C.int( int32(value)))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func (instance *SensitivityLabel) GetSiteId()  (string,  error)  {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZZM(C.CString("SensitivityLabel_GetSiteId"), instance.ptr)
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  "", err
	}
...
func (instance *SensitivityLabel) SetSiteId(value string)  error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZZN(C.CString("SensitivityLabel_SetSiteId"), instance.ptr, C.CString(value))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func (instance *SensitivityLabel) GetContentMarkType()  (SensitivityLabelMarkType,  error)  {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZZK(C.CString("SensitivityLabel_GetContentMarkType"), instance.ptr)
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  0, err
	}
...
func (instance *SensitivityLabel) SetContentMarkType(value SensitivityLabelMarkType)  error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZZL(C.CString("SensitivityLabel_SetContentMarkType"), instance.ptr, C.int( int32(value)))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  err
	}
...
func (instance *SensitivityLabelCollection) Add(id string, isenabled bool, methodtype SensitivityLabelAssignmentType, siteid string, marktype SensitivityLabelMarkType)  (int32,  error)  {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZPH(C.CString("SensitivityLabelCollection_Add"), instance.ptr, C.CString(id), C.bool(isenabled), C.int( int32(methodtype)), C.CString(siteid), C.int( int32(marktype)))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))	
		return  0, err
	}
