...
func Int32ToColorDepth(value int32) (ColorDepth, error) {
	switch value {
	case 0:
		return ColorDepth_Default, nil
	case 1:
		return ColorDepth_Format1bpp, nil
	case 4:
		return ColorDepth_Format4bpp, nil
	case 8:
		return ColorDepth_Format8bpp, nil
	case 24:
		return ColorDepth_Format24bpp, nil
	case 32:
		return ColorDepth_Format32bpp, nil
	default:
...
func Int32ToCommentTitleType(value int32) (CommentTitleType, error) {
	switch value {
	case 0:
		return CommentTitleType_Cell, nil
	case 1:
		return CommentTitleType_Comment, nil
	case 2:
		return CommentTitleType_Note, nil
	case 3:
		return CommentTitleType_Reply, nil
	default:
...
func Int32ToDrawObjectEnum(value int32) (DrawObjectEnum, error) {
	switch value {
	case 0:
		return DrawObjectEnum_Image, nil
	case 1:
		return DrawObjectEnum_Cell, nil
	default:
...
func Int32ToImageBinarizationMethod(value int32) (ImageBinarizationMethod, error) {
	switch value {
	case 0:
		return ImageBinarizationMethod_Threshold, nil
	case 1:
		return ImageBinarizationMethod_FloydSteinbergDithering, nil
	default:
...
func Int32ToPdfCompliance(value int32) (PdfCompliance, error) {
	switch value {
	case 0:
		return PdfCompliance_Pdf14, nil
	case 3:
		return PdfCompliance_Pdf15, nil
	case 4:
		return PdfCompliance_Pdf16, nil
	case 5:
		return PdfCompliance_Pdf17, nil
	case 1:
		return PdfCompliance_PdfA1b, nil
	case 2:
		return PdfCompliance_PdfA1a, nil
	case 6:
		return PdfCompliance_PdfA2b, nil
	case 7:
		return PdfCompliance_PdfA2u, nil
	case 8:
		return PdfCompliance_PdfA2a, nil
	case 9:
		return PdfCompliance_PdfA3b, nil
	case 10:
		return PdfCompliance_PdfA3u, nil
	case 11:
		return PdfCompliance_PdfA3a, nil
	default:
...
func Int32ToPdfCompressionCore(value int32) (PdfCompressionCore, error) {
	switch value {
	case 0:
		return PdfCompressionCore_None, nil
	case 1:
		return PdfCompressionCore_Rle, nil
	case 2:
		return PdfCompressionCore_Lzw, nil
	case 3:
		return PdfCompressionCore_Flate, nil
	default:
...
func Int32ToPdfCustomPropertiesExport(value int32) (PdfCustomPropertiesExport, error) {
	switch value {
	case 0:
		return PdfCustomPropertiesExport_None, nil
	case 1:
		return PdfCustomPropertiesExport_Standard, nil
	default:
...
func Int32ToPdfFontEncoding(value int32) (PdfFontEncoding, error) {
	switch value {
	case 0:
		return PdfFontEncoding_Identity, nil
	case 1:
		return PdfFontEncoding_AnsiPrefer, nil
	default:
...
func Int32ToPdfOptimizationType(value int32) (PdfOptimizationType, error) {
	switch value {
	case 0:
		return PdfOptimizationType_Standard, nil
	case 1:
		return PdfOptimizationType_MinimumSize, nil
	default:
...
func Int32ToTiffCompression(value int32) (TiffCompression, error) {
	switch value {
	case 0:
		return TiffCompression_CompressionNone, nil
	case 1:
		return TiffCompression_CompressionRle, nil
	case 2:
		return TiffCompression_CompressionLZW, nil
	case 3:
		return TiffCompression_CompressionCCITT3, nil
	case 4:
		return TiffCompression_CompressionCCITT4, nil
	default:
...
//
//	void
func (instance *SheetRender) ToTiff_Stream(stream []byte) error {

	CGoReturnPtr := C.SheetRender_ToTiff_Stream(instance.ptr, unsafe.Pointer(&stream[0]), C.int(len(stream)))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))
		return err
	}
...
func NewSheetSet_stringArray(sheetnames []string) (*SheetSet, error) {
	sheetset := &SheetSet{}
	CGoReturnPtr := C.New_SheetSet_U16StringArray(unsafe.Pointer(&sheetnames[0]), C.int(len(sheetnames)))
	if CGoReturnPtr.error_no == 0 {
		sheetset.ptr = CGoReturnPtr.return_value
		runtime.SetFinalizer(sheetset, DeleteSheetSet)
		return sheetset, nil
