...
set PATH=%PATH%;%GOPATH%\github.com\aspose-cells\aspose-cells-go-cpp\v25@v25.5.0\lib\win_x86_64\
...
$env:Path = $env:Path+ ";${env:GOPATH}\github.com\aspose-cells\aspose-cells-go-cpp\v25@v25.5.0\lib\win_x86_64\"
...
```bash
export PATH=$PATH:$GOPATH/github.com/aspose-cells/aspose-cells-go-cpp/v25@v25.5.0/lib/linux_x86_64/
...
go get github.com/aspose-cells/aspose-cells-go-cpp/v25@v25.5.0
