...
const (
	...
	VbaModuleType_Procedural VbaModuleType = 0

	// Represents a document module.
	VbaModuleType_Document VbaModuleType = 1
)

func Int32ToVbaModuleType(value int32) (VbaModuleType, error) {
	switch value {
	case 0:
		return VbaModuleType_Procedural, nil
	case 1:
		return VbaModuleType_Document, nil
	default:
		return 0, fmt.Errorf("invalid VbaModuleType value: %d", value)
	}
}
...
func Int32ToVbaProjectReferenceType(value int32) (VbaProjectReferenceType, error) {
	switch value {
	case 0:
		return VbaProjectReferenceType_Registered, nil
	case 1:
		return VbaProjectReferenceType_Control, nil
	case 2:
		return VbaProjectReferenceType_Project, nil
	default:
...
func (instance *VbaModule) GetType() (VbaModuleType, error) {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZZK(C.CString("VbaModule_GetType"), instance.ptr)
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))
		return 0, err
	}
	result, err := Int32ToVbaModuleType(int32(CGoReturnPtr.return_value))
	if err != nil {
		return 0, err
	}
...
func (instance *VbaModuleCollection) AddDesignerStorage(name string, data []byte) error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZPT(C.CString("VbaModuleCollection_AddDesignerStorage"), instance.ptr, C.CString(name), unsafe.Pointer(&data[0]), C.int(len(data)))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))
		return err
	}
...
func (instance *VbaModuleCollection) GetDesignerStorage(name string) ([]byte, error) {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZJU(C.CString("VbaModuleCollection_GetDesignerStorage"), instance.ptr, C.CString(name))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))
		return nil, err
	}
...
func (instance *VbaModuleCollection) Add_Worksheet(sheet *Worksheet) (int32, error) {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZFN(C.CString("VbaModuleCollection_Add_Worksheet"), instance.ptr, sheet_ptr)
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))
		return 0, err
	}
...
func (instance *VbaModuleCollection) Add_VbaModuleType_String(type_ VbaModuleType, name string) (int32, error) {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZEW(C.CString("VbaModuleCollection_Add_VbaModuleType_String"), instance.ptr, C.int(int32(type_)), C.CString(name))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))
		return 0, err
	}
...
func (instance *VbaModuleCollection) AddUserForm(name string, codes string, designerstorage []byte) (int32, error) {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZPU(C.CString("VbaModuleCollection_AddUserForm"), instance.ptr, C.CString(name), C.CString(codes), unsafe.Pointer(&designerstorage[0]), C.int(len(designerstorage)))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))
		return 0, err
	}
...
func (instance *VbaProject) Protect(islockedforviewing bool, password string) error {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZIR(C.CString("VbaProject_Protect"), instance.ptr, C.bool(islockedforviewing), C.CString(password))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))
		return err
	}
...
func (instance *VbaProjectReferenceCollection) AddRegisteredReference(name string, libid string) (int32, error) {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZJH(C.CString("VbaProjectReferenceCollection_AddRegisteredReference"), instance.ptr, C.CString(name), C.CString(libid))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))
		return 0, err
	}
...
func (instance *VbaProjectReferenceCollection) AddControlRefrernce(name string, libid string, twiddledlibid string, extendedlibid string) (int32, error) {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZPV(C.CString("VbaProjectReferenceCollection_AddControlRefrernce"), instance.ptr, C.CString(name), C.CString(libid), C.CString(twiddledlibid), C.CString(extendedlibid))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))
		return 0, err
	}
...
func (instance *VbaProjectReferenceCollection) AddProjectRefrernce(name string, absolutelibid string, relativelibid string) (int32, error) {
	...
	CGoReturnPtr := C.CellsGoFunctoinZZIY(C.CString("VbaProjectReferenceCollection_AddProjectRefrernce"), instance.ptr, C.CString(name), C.CString(absolutelibid), C.CString(relativelibid))
	if CGoReturnPtr.error_no != 0 {
		err := errors.New(C.GoString(CGoReturnPtr.error_message))
		return 0, err
	}
